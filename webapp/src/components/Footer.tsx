...
export default function Footer() {
  return (
    <footer className="bg-[var(--violet-dark)] text-white py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Logo et description */}
          <div>
            <Link href="/" className="font-bold text-xl text-white hover:no-underline">
              VUE D&apos;ENSEMBLE
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/methodologie" className="text-gray-300 hover:text-white">
                  La méthodologie
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-600 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Vue d&apos;Ensemble. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
